...
/**
 * Self-gates to null unless Kubernetes Monitoring is installed, the user can act on the CTAs, and
 * at least one recommended app is not already enabled — the recommendations are pitched as next
 * steps after Kubernetes Monitoring, so they make no sense without it.
 */
export default function Recommendations() {
  ...
  const canInstall =
    contextSrv.hasPermission(AccessControlAction.PluginsInstall) ||
    contextSrv.hasPermission(AccessControlAction.PluginsWrite) ||
