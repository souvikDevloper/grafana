...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	tokenExchanger, err := annotationsapi.ProvideTokenExchanger(cfg)
	if err != nil {
		return nil, err
	}
	migrationProxy, err := annotationsapi.ProvideMigrationProxy(cfg, userimplService, tokenExchanger)
	if err != nil {
		return nil, err
	}
